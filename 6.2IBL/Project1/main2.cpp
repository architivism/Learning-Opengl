...
int main()
{
    ...
    Shader shader("pbr_vertexSource.vert", "pbr_fragmentSource.frag");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        for (unsigned int i = 0; i < sizeof(lightPositions) / sizeof(lightPositions[0]); ++i)
        {
            ...
            shader.SetUniform3f(("lightPositions[" + std::to_string(i) + "]").c_str(), newPos);
            shader.SetUniform3f(("lightColors[" + std::to_string(i) + "]").c_str(), lightColors[i]);
