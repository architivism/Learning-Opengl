...
glm::vec3 cameraUp = glm::vec3(0.0f, 0.0f, 5.0f);
...
int main()
{
    ...
    //Models
    std::string exePath = "C:\\Users\\BaoTienen\\Desktop\\learn-opengl\\5.11SSAO\\Project1\\model\\nanosuit.obj";
    Model nanosuit(exePath);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::mat4 projection = glm::perspective(glm::radians(fov), (GLfloat)SCR_WIDTH / (GLfloat)SCR_HEIGHT, 0.1f, 50.0f);
